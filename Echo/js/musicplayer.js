$(function(){
	var playerTrack=$("#player-track"),
		...
		trackUrl = ['img/LOKEY低调组合%20-%20终点起点.mp3', 'img/LOKEY低调组合%20-%20终点起点.mp3', 'img/LOKEY低调组合%20-%20终点起点.mp3', 'img/LOKEY低调组合%20-%20终点起点.mp3', 'img/LOKEY低调组合%20-%20终点起点.mp3'],
		playPreviousTrackButton = $("#play-previous"),
		playNextTrackButton = $("#play-next"),
		hideButton=$("#HideButton"),
		currIndex = -1;
		
		console.log(currIndex+"s");
	function playPause(){
		setTimeout(function(){
			if(audio.paused){
	...
	/*-------------音乐切换-------------*/	
		...
		function initPlayer(){
			...
			dowebok.mouseover(function(){
				hideButton.addClass('active');
			})
			dowebok.mouseout(function(){
